...
class CompaniesLayout extends Component {
  constructor(props) {
    super(props);
  ...
  renderItem(item) {
    return (
      <TouchableOpacity onPress={() => this.props.navigation.navigate('OpenCompanyScreen', {itemId: item.item.id})} activeOpacity={0.8}>
